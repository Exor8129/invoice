...
const FooterTable = () => {
  return (
    <div className="table-container">
      ...
      <div className="table-wrapper">
        ...
        <table className="footer-table-2 ">
          ...
          <tbody className="footer-table-body-2">
            ...
            <td className="tablebdy"></td></tr>
            <tr><td>Total</td><td></td></tr>
            <tr><td>CGST</td><td></td></tr>
            <tr><td>SGST</td><td></td></tr>
            <tr><td>Round Off</td><td></td></tr>
            <tr><td>Grand Total</td><td></td></tr>
            <tr><td className="signature" colSpan={2}></td></tr>
      ...
      <div><h1 className="computerGen">This a hijas  Computer Generated Invoice</h1></div>
    </div>
  );
};
